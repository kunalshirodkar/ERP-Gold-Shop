<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
           ...
           <li><!-- <a href = "application.php"><i class="fa fa-file"></i> Application<span class="fa fa-chevron-right"></span></a>   -->   
            ...
            <!-- <li><a href = "empreport.php"><i class="fa fa-file"></i> Employee Reports<span class="fa fa-chevron-right"></span></a></li>
            <li><a href = "prodperformance.php"><i class="fa fa-file"></i> Product Performance<span class="fa fa-chevron-right"></span></a></li> -->
